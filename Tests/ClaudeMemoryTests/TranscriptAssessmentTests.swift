...
@Test func transcript_patternDiscovery() async throws {
    ...
    1. ClaudeMemoryLib (with .Cxx) — Lattice models, database code, embedding service
    2. ClaudeMemoryViews (no .Cxx) — SwiftUI views, depends on ClaudeMemoryLib
    3. ClaudeMemory (executable) — entry point, depends on both
    ...
    [Read file: Sources/ClaudeMemoryViews/MemoryListView.swift]
...
@Test func transcript_migrationDecision() async throws {
    ...
    [Read file: Sources/ClaudeMemoryLib/Memory.swift]
    ...
    [Edit file: Sources/ClaudeMemoryLib/Memory.swift]
    ```swift
    var tags: String?
...
@Test func transcript_formatting() async throws {
    ...
    [Run: git diff --stat]
    Sources/ClaudeMemoryLib/MemoryTools.swift          | 14 ++++---
    Sources/ClaudeMemoryLib/MemoryTools+Core.swift      | 22 +++++-----
    Sources/ClaudeMemoryLib/ToolHelpers.swift           |  8 ++--
    Sources/ClaudeMemoryLib/EmbeddingService.swift      |  4 +-
    Sources/ClaudeMemoryLib/Memory.swift                |  2 +-
    Sources/ClaudeMemory/main.swift                     |  6 +--
