...
@MainActor
public struct MetalPipelineBuilder {
    ...
    // MARK: - Node Pipeline (instanced, opaque, lit, depth-write ON)

    public static func buildNodePipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
        guard let vertexFn = library.makeFunction(name: "node_vertex_instanced"),
              let fragmentFn = library.makeFunction(name: "node_fragment") else {
            throw MetalPipelineError.functionNotFound("node_vertex_instanced or node_fragment")
        }

        let desc = MTLRenderPipelineDescriptor()
        desc.label = "Node Instanced Pipeline"
    ...
    // MARK: - Edge Pipeline (instanced, transparent, unlit, depth-write OFF)

    public static func buildEdgePipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
        guard let vertexFn = library.makeFunction(name: "edge_vertex_instanced"),
              let fragmentFn = library.makeFunction(name: "edge_fragment") else {
            throw MetalPipelineError.functionNotFound("edge_vertex_instanced or edge_fragment")
        }

        let desc = MTLRenderPipelineDescriptor()
        desc.label = "Edge Instanced Pipeline"
        desc.vertexFunction = vertexFn
        desc.fragmentFunction = fragmentFn
        // No vertex descriptor — manual buffer reads in shader
        desc.colorAttachments[0].pixelFormat = .bgra8Unorm
    ...
    public static func buildLabelPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildNebulaPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildFlowPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildMascotPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildArcaneCirclePipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildNodeRingPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildConjureScanPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
        guard let vertexFn = library.makeFunction(name: "arcane_vertex"),
    ...
    public static func buildConjureOrbPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildHoloScreenPipeline(device: MTLDevice, library: MTLLibrary) throws -> MTLRenderPipelineState {
    ...
    public static func buildOpaqueDepthState(device: MTLDevice) -> MTLDepthStencilState? {
    ...
    public static func buildTransparentDepthState(device: MTLDevice) -> MTLDepthStencilState? {
        let desc = MTLDepthStencilDescriptor()
