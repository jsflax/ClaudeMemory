...
//        guard !galaxy.isLoaded && !galaxy.isInitialLoad else { return }
//        galaxy.isInitialLoad = true
//
//        let batchSize = 50
//        let ref = galaxy.latticeRef
...
//            // Previously this loop ran on MainActor and took ~34s for 112K edges
//            // due to 4 dictionary operations per edge blocking the main thread.
...
//            }
//
//            // Assign precomputed dictionaries — 3 pointer swaps, not 448K dict ops
//            await MainActor.run {
//                let store = galaxy.renderStore
//                store.allEdges = allEdges
//                store.edgePkToGlobalId = edgePkToGlobalId
//                store.edgesByNode = edgesByNode
//            }
